...
export default function SubscriptionForm() {
  ...
  // Determine base URL: dev uses proxy (/api), prod uses REACT_APP_API_URL
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    try {
      // POST to either http://localhost:5000/api/subscribe (dev)
      // or https://successsubbackend.vercel.app/api/subscribe (prod)
      await axios.post(`${baseURL}/subscribe`, data);
      navigate('/success');
    } catch (err) {
